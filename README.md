...
-	[`alpine` (*Dockerfile*)](https://github.com/TobiasH87Docker/rpi-nginx/blob/master/alpine/Dockerfile) ([current Version: 1.14](https://pkgs.alpinelinux.org/package/v3.8/main/armhf/nginx) on AlpineLinux) 
-	[`1.10`, `latest` (*Dockerfile*)](https://github.com/TobiasH87Docker/rpi-nginx/blob/master/1.10/Dockerfile) (on Debian 9 Stretch)
